...
const TCHAR* const kGoopdateServer = _T("updates.aws.") COMPANY_DOMAIN;
...
const TCHAR* const kUrlUpdateCheck =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/service/update2");
...
const TCHAR* const kUrlCrashReport =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/cr/report");

// More information url.
// Must allow query parameters to be appended to it.
const TCHAR* const kUrlMoreInfo =
    _T("https://www.dentalwings.com/resources/software-download/?");

// Code Red check url.
const TCHAR* const kUrlCodeRedCheck =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/service/check2");

// Usage stats url.
const TCHAR* const kUrlUsageStatsReport =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/tbproxy/usagestats");

// App logo.
const TCHAR* const kUrlAppLogo =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/update2/installers/icons/");

#if defined(HAS_DEVICE_MANAGEMENT)

// Device Management API url.
const TCHAR* const kUrlDeviceManagement =
    _T("https://updates.aws.") COMPANY_DOMAIN _T("/devicemanagement/data/api");
